...
def main():
    ...
    trans32_score = computeMissScore(miss32, 350, 1150, maxscore['trans32']) * int(result32[0])
    trans64_score = computeMissScore(miss64, 1850, 4700, maxscore['trans64']) * int(result64[0])
    trans61_score = computeMissScore(miss61, 2000, 4400, maxscore['trans61']) * int(result61[0])
